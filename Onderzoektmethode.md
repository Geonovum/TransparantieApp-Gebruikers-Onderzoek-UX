...
In de eerste cyclus lag de focus op het verkennen van het probleem en het verkrijgen van inzicht in de eindgebruiker. Door middel van interviews met experts en deskresearch werd kennis verzameld, waarna relevante cases zijn geselecteerd en het probleem verder is afgebakend. Op basis hiervan is een eerste prototype ontwikkeld. Dit is gebruikt voor de ontwikkeling van een eerste concept, om de materie meer tastbaar te maken.

Dit prototype is geëvalueerd met eindgebruikers, waarbij specifiek is onderzocht welk mentaal model zij hebben van de werking van een hypothetische app en in hoeverre dit aansluit bij de werking en opzet van het ontwerp. Een mentaal model is de interne representatie of het begrip dat een gebruiker heeft over hoe een systeem werkt, gebaseerd op hun eerdere ervaringen en verwachtingen. Wanneer een applicatie niet aansluit bij het mentale model van de gebruiker, kan dit leiden tot verwarring of onjuist gebruik ( Nielsen & Norman, n.d.) Daarnaast zijn mogelijke br﻿uikbaarheidsproblemen en knelpunten in het begrip van het ontwerp geïdentificeerd.

De tweede cyclus richtte zich op het verfijnen en valideren van het ontwerp. In deze fase zijn inzichten uit de eerste cyclus aangevuld met state-of-the-art kennis, zoals UX-patronen, en input uit co-creatie en vragenlijsten.
...
Om de eindgebruiker tastbaar en bespreekbaar te maken binnen het team, is gebruikgemaakt van persona’s (Nielsen Norman Group, 2024). [Persona’s](https://www.nngroup.com/articles/persona/) zijn fictieve, maar op onderzoek gebaseerde representaties van gebruikers waarin doelen, behoeften en gedrag worden samengebracht. Deze helpen om abstracte doelgroepen concreet te maken en ondersteunen het team bij het nemen van gebruikersgerichte beslissingen. Dit helpt het team zich te verplaatsen in de eindgebruiker.

De uitgewerkte persona's die in dit onderzoek zijn gebruikt, zijn in detail terug te vinden in Bijlage A.

De persona’s zijn in eerste instantie gebaseerd op literatuuronderzoek. Hoewel ze idealiter voortkomen uit primair gebruikersonderzoek, boden ze in deze fase al waardevolle inzichten in de context waarin burgers zich bevinden. Burgers hebben namelijk te maken met verschillende externe factoren die invloed hebben op hun gedrag en keuzes. Door deze context mee te nemen, wordt het duidelijker waarom gebruikers op verschillende manieren reageren op transparantie over datagebruik. Hierbij is het belangrijk dat de persona’s een bredere groep gebruikers vertegenwoordigen dan alleen de standaard beoogde doelgroepen. Dit draagt bij aan een inclusiever en diverser ontwerpproces.
...
Er zijn twee situaties geselecteerd:

- Het bepalen van de WOZ-waarde van een woning.

- Het gebruik en de uitwisseling van medische gegevens binnen een persoonlijk zorgdomein.

Deze casussen maakten het mogelijk om het abstracte concept van datalogging te vertalen naar herkenbare situaties voor burgers. Op basis hiervan konden prototypes worden ontwikkeld en getest, met als doel generieke UX-patronen te identificeren.

Bij het kiezen van de casussen de volgende uitgangspunten gehanteerd:

- Het loggen van data moet bijdragen aan het oplossen van een daadwerkelijk gebruikersprobleem.
...
Technisch vaardige gebruikers zijn wegens efficiëntie getest via unmoderated en/of moderated usability tests met behulp van de tool [Lyssna](https://www.lyssna.com/). Deze tool maakt het mogelijk om tegen betaling snel gebruikers te rekruteren, om zo sneller en efficiënter gebruikerstesten af te nemen. Voor de afname van de ouderen testen is het persoonlijk netwerk ingezet. De gebruikerstesten bevatten relatief veel technisch vaardige deelnemers en vormen geen representatieve afspiegeling van oudere, digitaal minder vaardige burgers.
...
- **Moeilijk te plannen:** Omdat doelen per sprint verschuiven, ontbreekt vaak een helder eindbeeld voor budgetten en deadlines. Bij klanten kan de exacte uitkomst dus

- **Hoge werkdruk:** Het strakke tempo en de continue focus op opleveren kunnen zorgen voor stress bij teamleden.

- **Weerstand tegen cultuurverandering:** Niet elke organisatie of medewerker past bij een flexibele, zelfsturende manier van werken.

- **Gebrek aan vastheid:** Door het loslaten van vaste plannen kan sturing en richting tijdelijk verdwijnen.

- **Weinig documentatie:** Door de focus op snelheid en voortgang kan de formele vastlegging van keuzes achterblijven.
